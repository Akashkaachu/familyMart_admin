...
//set
  static Future<bool> saveAdminLoggedfun(bool userLogged) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    return pref.setBool(userLoggedKey, userLogged);
  }

  //set   userId
  static Future<bool> saveAdminId(String userId) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    return pref.setString(userIdKey, userId);
  }

  //set accesToken
  static Future<bool> saveAdminAccessToken(String accessToken) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
